...
export default function ProductCart({ product }) {
     ...
     const { key, name, colors, status } = product;
     ...
     return (
          <div className="group relative mb-10 overflow-hidden">
               <div className="relative">
                    ...
                    {status !== "" ? <span className={`absolute top-5 left-0 ${status == "new" ? "bg-white text-neutral-900" : status == "sale" ? "bg-neutral-900 text-white" : "bg-blue-500 text-white"} font-bold tracking-widest uppercase text-xs py-1 px-4`}>{status}</span> : ""}
