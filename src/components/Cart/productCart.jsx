     ...
     return (
          <div className="group relative mb-10 overflow-hidden">
               ...
               <div className="relative mt-6">
                    ...
                    <div className="absolute bottom-0 right-0 invisible opacity-0 group-hover:visible group-hover:opacity-100 sl-animated-xl">
                              <ul className="flex">
                                   {sizes && sizes.map((size, index) => (
                                        <li key={index} className="relative w-9 h-5 flex items-center justify-center font-bold uppercase mr-4">
