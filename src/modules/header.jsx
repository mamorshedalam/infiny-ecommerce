               ...
               <div className="px-9">
                    <div className="flex flex-wrap items-center justify-between max-w-[1600px] w-full py-4 mx-auto">
                         ...
                         <div className="flex items-center">
                              <NavLink to={`search`} className={({ isActive }) => isActive ? "fill-red-500 mr-6" : "fill-neutral-900 mr-6 hover:fill-red-500 sl-animated-xl"}>
                              ...
                              <NavLink to={`/cart`} className={({ isActive }) => isActive ? "fill-red-500" : "fill-neutral-900 hover:fill-red-500 sl-animated-xl"}>
